...
pub struct PublicOcrInput {
    ...
    pub ai_ocr_api_key_configured: bool,
...
pub fn public_request_payload(spec: &ResolvedJobSpec) -> PublicResolvedJobSpec {
    PublicResolvedJobSpec {
        ...
        ocr: PublicOcrInput {
            ...
            ai_ocr_api_key_configured: !spec.ocr.ai_ocr_api_key.trim().is_empty(),
            ai_ocr_model: spec.ocr.ai_ocr_model.clone(),
            ai_ocr_base_url: spec.ocr.ai_ocr_base_url.clone(),
